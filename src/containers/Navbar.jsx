...
// Professional gradient colors based on royal blue (#4169E1)
const COLOR_PALETTE = {
  primary: '#4169E1',
  secondary: '#6A5ACD',
  accent: '#00B4D8',
  ...
  gradient: {
    ...
    navbarLight: 'linear-gradient(135deg, #FFFFFF 0%, #F8F9FF 50%, #E3F2FD 100%)',
    navbarDark: 'linear-gradient(135deg, #0A0F2D 0%, #1A1F4B 50%, #002A32 100%)',
    drawerLight: 'linear-gradient(180deg, #FFFFFF 0%, #F8F9FF 100%)',
    drawerDark: 'linear-gradient(180deg, #1A1F4B 0%, #0A0F2D 100%)'
  }
};
...
const ColorfulBadge = styled(Badge)(({ theme }) => ({
  '& .MuiBadge-badge': {
    background: COLOR_PALETTE.gradient.light,
    color: 'white',
    fontWeight: 'bold',
    fontSize: '0.7rem',
    minWidth: 18,
...
export default function Navbar() {
  ...
  const notificationItems = [
    'New patient appointment scheduled for tomorrow',
          ...
          <Box sx={{ 
            ...
            {languages.map((lang) => (
              <IconButton
                ...
                sx={{
                  flexDirection: 'column',
                  background: i18n.language === lang.code ? alpha(theme.palette.primary.main, 0.2) : alpha(theme.palette.primary.main, 0.05),
                  borderRadius: 3,
                  p: 1.5,
                  minWidth: 70,
                  border: i18n.language === lang.code ? `2px solid ${theme.palette.primary.main}` : 'none',
                }}
              >
                <img
                  src={lang.flag}
      ...
      sx={{
        "& .MuiPaper-root": {
          ...
          background: mode === 'light' 
            ...
            : 'linear-gradient(135deg, #1A1F4B 0%, #0A0F2D 100%)',
          border: `1px solid ${alpha(theme.palette.primary.main, 0.1)}`,
        },
      }}
    >
          ...
          <Toolbar sx={{ 
            ...
            <Box sx={{ 
              ...
              <Typography
                ...
                sx={{
                  ...
                  color: theme.palette.text.primary,
                  background: mode === 'light' 
                    ? COLOR_PALETTE.gradient.light 
                    : COLOR_PALETTE.gradient.dark,
                  backgroundClip: 'text',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  display: { xs: 'none', sm: 'block' } // Hidden on extra small, shown on small and up
                }}
              >
                Dr Jelassi Joury
              </Typography>
            ...
            <Box sx={{ 
              ...
              <Box sx={{ display: { xs: 'flex', md: 'none' }, alignItems: 'center', gap: 0.5 }}>
                {/* Theme Toggle Button - Strategic Position */}
                <IconButton
                  size="large"
                  onClick={colorMode.toggleColorMode}
                  aria-label={mode === 'dark' ? t("lightMode") : t("darkMode")}
